...
<template>
  <section class="mt-8 rounded-xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 bg-white dark:bg-slate-900">
    ...
    <div class="mt-4 rounded-lg border border-slate-200 dark:border-slate-700 p-4 bg-slate-50/60 dark:bg-slate-900/40">
    ...
    <div class="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
      <div class="rounded-lg border border-slate-200 dark:border-slate-700 p-3 bg-slate-50/40 dark:bg-slate-900/30">
    ...
    <div v-if="result.narrowPoints?.length" class="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800">
      ...
      <ul class="mt-2 space-y-2 text-sm text-slate-700 dark:text-slate-300 list-disc pl-5">
    ...
    <div v-if="result.hiddenRisks?.length" class="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800">
      <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
    ...
    <div v-if="result.missingProtections?.length" class="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800">
      <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
    ...
    <div v-if="result.questionsToClarify?.length" class="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800">
      <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
    ...
    <div v-if="result.creatorNegotiationPriorities?.length" class="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800">
      <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
    ...
    <div v-if="sortedRedFlags.length" class="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800 space-y-3">
      <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
      ...
      >
        ...
        <p class="mt-2 text-sm text-slate-700 dark:text-slate-300 break-words">
          Clause: <code class="px-1 py-0.5 rounded bg-slate-100 dark:bg-slate-800 break-words">{{ item.clauseQuote }}</code>
        </p>
        <p class="mt-1 text-sm text-slate-700 dark:text-slate-300">
