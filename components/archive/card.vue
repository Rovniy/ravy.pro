...
<template>
  <article class="group relative grid grid-cols-1 sm:grid-cols-10 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl bg-white dark:bg-slate-900/50 text-zinc-700 dark:text-zinc-300 transition-all duration-300 hover:-translate-y-1.5 hover:border-sky-300 dark:hover:border-sky-700/60 focus-within:ring-2 focus-within:ring-sky-400">
    <NuxtLink
      :to="path"
      :aria-label="title"
