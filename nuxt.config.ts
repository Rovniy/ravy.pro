  ...
  content: {
    build: {
      markdown: {
        highlight: {
          theme: 'dracula',
          // Replaces @nuxtjs/mdc's default list, so its entries are repeated
          // here. A fence in a language missing from this list still renders,
          // just unhighlighted — add it here, each one is a lazy chunk.
          langs: [
            'js',
            'jsx',
            'json',
